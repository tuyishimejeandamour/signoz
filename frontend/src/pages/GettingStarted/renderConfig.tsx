...
export const GetStartedContent = (): TGetStartedContentSection[] => {
	...
	return [
		{
			heading: 'Send data from your applications to Trinity',
			items: [
				{
		...
		{
			heading: 'Send your logs to Trinity',
			items: [
				{
					title: 'Send your logs to Trinity',
					icon: <AlignLeftOutlined style={{ fontSize: '3.5rem' }} />,
					url: 'https://signoz.io/docs/userguide/logs/',
				},
				{
					title: 'Existing log collectors to Trinity',
		...
		},
		{
			...
			items: [
				{
					title: 'Join Trinity slack community ',
					icon: (
