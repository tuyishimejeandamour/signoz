...
Once you have completed the prerequisites, you can start monitoring your Azure App Service's system metrics with Trinity Cloud. Here's how you can do it:
...
In this way, you can monitor system metrics of your Azure App Service in Trinity Cloud.
