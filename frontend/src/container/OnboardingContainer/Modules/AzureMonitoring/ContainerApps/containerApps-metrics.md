...
Once you have completed the prerequisites, you can start monitoring your Azure Container App's system metrics with Trinity. Here's how you can do it:
...
In this way, you can monitor system metrics of your Azure Container App in Trinity!
