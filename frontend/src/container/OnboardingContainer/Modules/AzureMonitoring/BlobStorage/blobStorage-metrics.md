...
Once you have completed the prerequisites, you can start monitoring your Azure Blob Storage's system metrics with Trinity.

1. Log in to your Trinity account.
...
That's it! You have successfully set up monitoring for your Azure Blob Storage's system metrics with Trinity. You can now start creating other panels and dashboards to monitor other Azure Blob Storage's metrics.
