...
Based on your application environment, you can choose the setup below to send traces to Trinity Cloud.

### Application on VMs

From VMs, there are two ways to send data to Trinity Cloud.

- Send traces directly to Trinity Cloud (quick start)
- Send traces via OTel Collector binary (recommended)

#### **Send traces directly to Trinity Cloud**
OpenTelemetry Java agent can send traces directly to Trinity Cloud.
...
OTel Collector binary helps to collect logs, hostmetrics, resource and infra attributes. It is recommended to install Otel Collector binary to collect and send traces to Trinity cloud. You can correlate signals and have rich contextual data through this way.
...
This should set these environment variables and start sending telemetry data to Trinity Cloud.
...
For Java application deployed on Kubernetes, you need to install OTel Collector agent in your k8s infra to collect and send traces to Trinity Cloud. You can find the instructions to install OTel Collector agent [here](https://signoz.io/docs/tutorial/kubernetes-infra-metrics/).
...
This should set the environment variable and start sending telemetry data to Trinity Cloud.
...
You can validate if your application is sending traces to Trinity cloud by following the instructions [here](https://signoz.io/docs/instrumentation/tomcat/#validating-instrumentation-by-checking-for-traces).