...
This file will have your Trinity cloud endpoint and service name configued as values of `url` and `SERVICE_NAME` respectively.
...
You can now run your Nestjs application. The data captured with OpenTelemetry from your application should start showing on the Trinity dashboard.
...
For Javascript application deployed on Kubernetes, you need to install OTel Collector agent in your k8s infra to collect and send traces to Trinity Cloud. You can find the instructions to install OTel Collector agent [here](https://signoz.io/docs/tutorial/kubernetes-infra-metrics/).
