...
Add `init_tracer` function to your `main.rs` file. It initializes an OpenTelemetry tracer with the OpenTelemetry OTLP exporter which is sending data to Trinity Cloud.
...
Add the below code block within a function or a section of your code where you're setting up and using the tracer for distributed tracing. After adding the below code block you can send traces to Trinity Cloud
  ...
  let tracer = global::tracer("global_tracer");
    ...
    tracer.in_span("operation", |cx| {
        ...
        span.add_event(
            format!("Operations"),
            vec![
                Key::new("Trinity is").string("working!"),
            ],
        );
    });
...
The above code block will create a span named operation which sets an attribute and an event to it saying "Trinity is working!".
