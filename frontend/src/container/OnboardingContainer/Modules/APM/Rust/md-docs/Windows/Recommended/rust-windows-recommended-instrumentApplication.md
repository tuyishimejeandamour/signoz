...
Add this function in main.rs file, `init_tracer` is initializing an OpenTelemetry tracer with the OpenTelemetry OTLP exporter which is sending data to Trinity Cloud. 
...
Now comes the most interesting part, Sending data to Trinity to get sense of your traces. After adding the below block you can send traces to Trinity cloud
  ...
  let tracer = global::tracer("global_tracer");
    ...
    tracer.in_span("operation", |cx| {
        ...
        span.add_event(
            format!("Operations"),
            vec![
                Key::new("Trinity is").string("Awesome"),
            ],
        );
    });
