...
You can stream logs from Vercel to Trinity using [log drains](https://vercel.com/docs/observability/log-drains-overview/log-drains#configure-a-log-drain).
...
Click on the **Done** button below and you should be able to see your logs in Trinity.