...
To send logs data from applications deployed in ECS to Trinity Cloud using sidecar container we created in the previous steps, follow these steps:
...
Generate some logs from your application and go to your Trinity cloud **Logs** page to see your application logs.
