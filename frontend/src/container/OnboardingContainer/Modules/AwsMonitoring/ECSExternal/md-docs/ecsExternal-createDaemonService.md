...
Using the template we downloaded and the Trinity OpenTelemetry Collector configuration we created, we will create the Daemon Service. This can be done following these steps:
...
### Step 4: Verify Data in Trinity

To verify that the data is being sent to Trinity Cloud, you can go to the dashboard section of Trinity and import one of the following dashboards below:
...
Once you follow these steps, you should be able to see your logs and metrics data coming in Trinity Cloud. To see data for your traces, click on Continue to next step below.