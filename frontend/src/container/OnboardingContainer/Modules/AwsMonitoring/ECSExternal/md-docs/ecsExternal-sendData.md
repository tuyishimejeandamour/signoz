...
To send traces data from applications deployed in ECS to Trinity Cloud using Daemon Service we created in the previous section, follow these steps:
...
### Step 5: Step 5: Verify Data in Trinity

Generate some traffic to your application and go to your Trinity cloud services page to see your application name in the service list.
