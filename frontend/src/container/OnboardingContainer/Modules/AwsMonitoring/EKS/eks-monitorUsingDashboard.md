...
You should copy the JSON data in these files and create a New Dashboard in the Dashboard Tab of Trinity.

&nbsp;

By following the previous step, you should also be able to see Kubernetes Pod logs in the logs Section of Trinity.
